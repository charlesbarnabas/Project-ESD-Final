...
export default function SignUp() {
  const { state, method } = useAuthSignup();
    ...
    <div className="w-screen h-screen flex justify-center items-center">
      <div className="flex flex-col gap-8 w-[450px]">
        <div className="flex flex-col justify-start gap-4">
          ...
          <h2 className="font-medium text-2xl">Sign Up to Get Started</h2>
        </div>
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-4">
            ...
            <input
              ...
              onChange={(input) => method.onChangeUsername(input.target.value)}
            />
          </div>
          <div className="flex flex-col gap-4">
        ...
        <button
          onClick={() => method.onClickBtnRegister()}
        ...
        <div className="flex justify-start items-center gap-2">
          ...
          <Link className="text-sm font-bold" to="/auth/signin">
            Sign In
          </Link>
        </div>
      </div>
